      ...
      <div className="relative z-10">
        <div className="max-w-5xl px-4 xl:px-0 mx-auto">
          ...
          <div className="flex flex-wrap justify-center sm:justify-between gap-6">
            ...
            {/* Logo 2: Shopify */}
            <img
              className="py-3 lg:py-5 w-36 h-auto md:w-38 lg:w-40 text-neutral-400"
              src="/strategy.svg"
            ></img>

            <img
              className="py-3 lg:py-5 w-26 h-auto md:w-34 lg:w-40 text-neutral-400"
              src="/lepa.svg"
            ></img>

            <img
              className="py-3 lg:py-5 w-26 h-auto md:w-34 lg:w-32 text-neutral-400"
              src="/synergys.svg"
            ></img>
            ...
            <img
              className="py-3 lg:py-5 w-18 h-auto md:w-28 lg:w-28 text-neutral-400"
